 ...
 * @returns SVG element for solid line icon
 */
const SolidLineComponent: React.FC<IconProps> = ({
	width = 24,
	height = 24,
	fill = "#333333",
	title,
...
export const SolidLine = memo(SolidLineComponent);
