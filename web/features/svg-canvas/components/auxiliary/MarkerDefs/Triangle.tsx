...
/**
 * Triangle arrow marker definition.
 * Creates a standard triangular arrow head marker for use with SVG paths.
 * Uses context-stroke to inherit color from the path.
 */
const TriangleMarkerComponent: React.FC = () => {
	return (
		<marker
			id="marker-triangle"
...
export const TriangleMarker = memo(TriangleMarkerComponent);
